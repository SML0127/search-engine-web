...
export class RowScrapperNode extends Node {
    constructor(props){
        super(props)
        this.state = {
            modalShow:false,
                ...
                <Modal.Footer>
                    <Button color="primary" 
                        onClick={(obj) => {
                                ...
                                var table_name = obj.currentTarget.parentNode.parentNode.childNodes[1].childNodes[1].value
                                var table_rows = obj.currentTarget.parentNode.parentNode.childNodes[1].childNodes[3].childNodes[1].childNodes
